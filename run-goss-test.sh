...
java -server -Xmx4g -Dbigdata.propertyFile=$GRIDAPPSD_PROJECT/builds/conf/rwstore.properties -jar lib/blazegraph.jar >> $GRIDAPPSD_PROJECT/builds/log/blazegraph.log 2>&1 &
BGPID=`echo $!`
