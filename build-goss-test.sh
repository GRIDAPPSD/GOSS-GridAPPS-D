...
cp gov.pnnl.goss.gridappsd/applications/python/fncs_goss_bridge.py ~/gridappsd_project/builds/scripts/
cp gov.pnnl.goss.gridappsd/applications/etc/zipload_schedule.player ~/gridappsd_project/builds/scripts/
