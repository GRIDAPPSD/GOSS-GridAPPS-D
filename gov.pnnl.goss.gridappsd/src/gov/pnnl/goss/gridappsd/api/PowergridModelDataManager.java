...
public interface PowergridModelDataManager {
    ...
    String queryObject(String modelId, String mrid, String resultFormat, String processId, String username)
            throws Exception;
    ...
    String queryModel(String modelId, String objectType, String filter, String resultFormat, String processId,
    ...
    String queryObjectDictByType(String resultFormat, String modelId, String objectType, String objectId,
            String processId, String username) throws Exception;

    ResultSet queryObjectDictByTypeResultSet(String modelId, String objectType, String objectId, String processId,
            String username);

    String queryMeasurementDictByObject(String resultFormat, String modelId, String objectType, String objectId,
            String processId, String username) throws Exception;

    ResultSet queryMeasurementDictByObjectResultSet(String modelId, String objectType, String objectId,
    ...
    // Also will need putObject and deleteObject (will need to support the right
