...
//	
	...
	//test that added to registry when start is called, registry and data sources should have content
	//	test updated
	//  test get data source keys
	// test get data source by key
	// test get connection by key
	// test stop, registry and data sources should be cleared
	// test what happens when update is not called 
