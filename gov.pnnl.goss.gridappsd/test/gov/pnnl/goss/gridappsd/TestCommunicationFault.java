...
public class TestCommunicationFault {
    ...
    public void testFault() {
        ...
        // RuntimeTypeAdapterFactory<BaseEventCommand> commandAdapterFactory =
        // RuntimeTypeAdapterFactory.of(BaseEventCommand.class, "type")
        // .registerSubtype(FaultCommand.class,"FaultCommand")
        // .registerSubtype(EventCommand.class, "EventCommand");

        // RuntimeTypeAdapterFactory<BaseEvent> eventAdapterFactory =
        // RuntimeTypeAdapterFactory.of(BaseEvent.class, "type")
        ...
        // String tempStr =
        // "{\"inputList\":[{\"objectMRID\":\"UU123214\",\"attribute\":\"RegulatingControl.mode\"}],\"outputList\":[\"UU12323\"],\"filterAllInputs\":false,\"filterAllOutputs\":false,\"timeInitiated\":1248156005,\"timeCleared\":1248156008}";
        ...
        // BaseEventCommand testEventCommand2 = gson.fromJson(tempString,
        // BaseEventCommand.class);
        ...
        JsonObject firstForwardObject = inputObject.get("message").getAsJsonObject().get("forward_differences")
                .getAsJsonArray().get(0).getAsJsonObject();
        Assert.assertEquals(firstForwardObject.get("attribute").getAsString(), "FilterObject");

        Assert.assertEquals(firstForwardObject.get("value").getAsJsonObject().get("inputList").getAsJsonArray().get(0)
                .getAsJsonObject().get("attribute").getAsString(), "RegulatingControl.mode");

        // HashMap<Integer, ProcessEvents> processEventsMap = new HashMap<Integer,
        // ProcessEvents>(10);
        // ProcessEvents pe;
