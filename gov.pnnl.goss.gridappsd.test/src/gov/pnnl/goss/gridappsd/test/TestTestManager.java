...
public class TestTestManager {
    ...
    public void before() throws InterruptedException {
        testConfig = org.amdatu.testing.configurator.TestConfigurator.configure(this)
                ...
                .add(org.amdatu.testing.configurator.TestConfigurator.createServiceDependency()
                        .setService(ClientFactory.class))
                .add(org.amdatu.testing.configurator.TestConfigurator.createServiceDependency()
                        .setService(Logger.class))
                .add(org.amdatu.testing.configurator.TestConfigurator.createServiceDependency()
                        .setService(SecurityManager.class))
                .add(org.amdatu.testing.configurator.TestConfigurator.createServiceDependency()
                        .setService(ServerControl.class));
        testConfig.apply();
