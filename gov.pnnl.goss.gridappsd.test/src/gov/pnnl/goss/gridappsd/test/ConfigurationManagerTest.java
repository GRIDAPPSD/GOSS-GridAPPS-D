...
public class ConfigurationManagerTest {
    ...
    public static void main(String[] args) {
        ...
        try {
            // test.simulationId =
            // test.getClient().getResponse(TestConstants.REQUEST_SIMULATION_CONFIG_ESC,
    ...
    public String startSimulation() throws Exception {
        ...
        Serializable response = client.getResponse(TestConstants.REQUEST_SIMULATION_CONFIG_ESC,
    ...
    public void testgetGLMBaseConfiguration() {
        ...
        try {
            ...
            Serializable response = client.getResponse(configRequest.toString(), GridAppsDConstants.topic_requestConfig,
